  ...
  scenes: [
    {
      ...
      motionGraphic: {
        shapeVocabulary: "diagonal shards, sharp rectangles",
        movementBehavior: "burst outward from center fast",
        thematicLink: "speed and sharp precision of the product",
        layerPosition: "full",
        imageIntegration: false,
      },
      text: { headline: "The Future Is Here", subtext: "Next-generation technology" },
      voiceLine: "The future is here, and it changes everything.",
    ...
    },
    {
      ...
      motionGraphic: {
        shapeVocabulary: "circles, orbs, spheres",
        movementBehavior: "drift upward slowly",
        thematicLink: "smooth and effortless user experience",
        layerPosition: "background",
        imageIntegration: false,
      },
      text: { headline: "Instant Results", subtext: "Achieve more in less time" },
      voiceLine: "Experience instant results that speak for themselves.",
    ...
    },
    {
      ...
      motionGraphic: {
        shapeVocabulary: "hexagons, blocks",
        movementBehavior: "assemble from scattered positions",
        thematicLink: "building blocks of innovation",
        layerPosition: "foreground",
        imageIntegration: false,
      },
      text: { headline: "Built Different", subtext: "Leading the industry" },
      voiceLine: "Built different from the ground up for you.",
    ...
    },
    {
      ...
      label: "Social proof",
      motionGraphic: {
        shapeVocabulary: "lines, beams",
        movementBehavior: "wave motion horizontal",
        thematicLink: "flowing momentum of growth",
        layerPosition: "background",
        imageIntegration: false,
      },
      text: { headline: "Trusted Worldwide", subtext: "Join thousands of happy customers" },
      voiceLine: "Trusted by thousands of customers worldwide.",
      animationStyle: "wave",
      colorScheme: defaultColorScheme,
      audioPath: "",
      duration: 120,
    },
    {
      ...
      motionGraphic: {
        shapeVocabulary: "triangles, spikes",
        movementBehavior: "pulse outward rhythmically",
        thematicLink: "urgency and excitement to act now",
        layerPosition: "full",
        imageIntegration: false,
      },
      text: { headline: "Start Today" },
      voiceLine: "Start your journey today and never look back.",
      ...
      <Composition
        ...
        calculateMetadata={async ({ props }) => {
          ...
          if (latestPlanData && latestPlanData.scenes && latestPlanData.scenes.length >= 2) {
            planData = latestPlanData as unknown as typeof defaultPlan;
          }
